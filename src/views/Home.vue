<template>
    <div class="home-container">
        <div class="home">
            <div class="welcome-container">
                <div class="img-container">
                    <img class="profile-img" src="/images/profile.png" alt="moi">
                    <h2 class="image-caption">Adrien Forcada</h2>
                </div>
                <div>
                    <h2 class="welcome-text">Bienvenue sur mon Portfolio!</h2>
                    <p> "Ainsi ce qui est utile est beau relativement à l'usage auquel il est utile." <strong>-Socrate</strong> </p>
                </div>
            </div>
        </div>
        <div class="home">
        ...
        <div class="welcome-container" style="justify-content:center;">
            <p style="color:black;">Follow me here </p>
            <a class="social-img-link" href="https://www.linkedin.com/in/adrien-forcada-b7ba4a239">
            ...
            <a class="social-img-link" href="https://github.com/ForcadaA">
            ...
            <a class="social-img-link" href="https://codepen.io/forcadaa/">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M502.285 159.704l-234-156c-7.987-4.915-16.511-4.96-24.571 0l-234 156C3.714 163.703 0 170.847 0 177.989v155.999c0 7.143 3.714 14.286 9.715 18.286l234 156.022c7.987 4.915 16.511 4.96 24.571 0l234-156.022c6-3.999 9.715-11.143 9.715-18.286V177.989c-.001-7.142-3.715-14.286-9.716-18.285zM278 63.131l172.286 114.858-76.857 51.429L278 165.703V63.131zm-44 0v102.572l-95.429 63.715-76.857-51.429L234 63.131zM44 219.132l55.143 36.857L44 292.846v-73.714zm190 229.715L61.714 333.989l76.857-51.429L234 346.275v102.572zm22-140.858l-77.715-52 77.715-52 77.715 52-77.715 52zm22 140.858V346.275l95.429-63.715 76.857 51.429L278 448.847zm190-156.001l-55.143-36.857L468 219.132v73.714z"/></svg>
            </a>
        </div>
    </div>
</template>
